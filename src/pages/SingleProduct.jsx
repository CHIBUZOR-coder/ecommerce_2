          ...
          <div className=" flex flex-col justify-end gap-3">
            ...
            <div className=" flex items-center gap-3">
              <input
                ...
                type="number"
                className="border-[2px] p-2 outline-none"
              />

              <button
                onClick={() => HandleAddToCart(singleProduct, Size, quantity)}
                className="bg-black rounded-md text-white  hover:bg-black hover:text-white transition ease-in-out duration-500 p-2"
              >
                Add To Cart
              </button>
            </div>
